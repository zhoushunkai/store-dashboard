...
const App = {
  ...
  seedData: {
    ...
    {id: 'sd_dr_001', inspector: '钱磊', date: '2026-07-29', type: 'online', items: [{store: '天慧广场店', score: 94, findings: '[QSC] 超五分钟未翻动；[QSC] 铲子掉落台面继续使用；[QSC] 超30分钟未处理'}, {store: '万航渡路店', score: 91, findings: '[QSC] 填补餐具未戴手套；[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 打包盒接触隔层'}, {store: '杨庄东街店', score: 95, findings: '[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 仪容仪表不合格'}, {store: '左安门店', score: 92, findings: '[QSC] 菜刀接触保鲜盒底；[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 仪容仪表不合格'}, {store: '汇融天地店', score: 86, findings: '[QSC] 带耳钉；[QSC] 仪容仪表不合格；[QSC] 未戴口罩；[QSC] 接触馒头未戴手套；[QSC] 午餐炒菜断档；[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理'}, {store: '朝丰家园店', score: 90, findings: '[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 夹子接触盖子；[QSC] 炒锅洗份数盒'}, {store: '马家堡店', score: 94, findings: '[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 夹子接触台面'}, {store: '丰管路店', score: 94, findings: '[QSC] 超五分钟未翻动；[QSC] 超30分钟未处理；[QSC] 夹子接触台面；[QSC] 报损过多'}]},

    {id: 'sd_dr_002', inspector: '钱磊', date: '2026-07-30', type: 'online', items: [{store: '郁花园店', score: 95, findings: '[QSC] 未规范佩戴口罩；[QSC] 仪容仪表不合格；[QSC] 未溜边放'}, {store: '物资学院店', score: 88, findings: '[QSC] 佩戴首饰；[QSC] 仪容仪表不合格；[QSC] 米饭未加盖；[QSC] 包装袋入水；[QSC] 关火一分钟后出餐；[QSC] 米饭未及时打散'}, {store: '青年路店', score: 90, findings: '[QSC] 饮料未用规定工具称量；[QSC] 垃圾桶垃圾溢出；[QSC] 金针菇未软榻；[QSC] 汤汁少'}, {store: '旧宫店', score: 90, findings: '[QSC] 锅贴煎制时间不足；[QSC] 筷子掉落台面；[QSC] 米饭未及时打散；[QSC] 焯水时间过长；[QSC] 佩戴首饰'}, {store: '太平街店', score: 87, findings: '[QSC] 浇油操作错误；[QSC] 2米饭未加盖；[QSC] 3打烊过早；[QSC] 4交叉污染；[QSC] 5自助服务区未及时清洁；[QSC] 6未使用专用称量器具'}]},

    {id: 'sd_dr_003', inspector: '钱磊', date: '2026-07-31', type: 'online', items: [{store: '通胡大街店', score: 90, findings: '[QSC] 打烊过早；[QSC] 仪容仪表不合格；[QSC] 交叉污染，煮台热料包；[QSC] 未及时加盖；[QSC] 米饭未及时打散'}, {store: '木樨园桥西店', score: 91, findings: '[QSC] 打烊过早；[QSC] 交叉污染；[QSC] 热料包方式错误；[QSC] 水未开下米'}, {store: '交大东路店', score: 87, findings: '[QSC] 米饭未及时打散；[QSC] 工牌无名字；[QSC] 货物掉落地面；[QSC] 炒肉无锅圈；[QSC] 饮料未使用规定器具称量；[QSC] 米饭未及时加盖'}, {store: '丰台南路店', score: 89, findings: '[QSC] 只放辣椒未放油；[QSC] 仪容仪表不合格；[QSC] 锅圈接触台面后继续使用；[QSC] 米饭未及时打散；[QSC] 米饭未及时加盖'}, {store: '和平东桥店', score: 92, findings: '[QSC] 筷子头落入烤鱼酱；[QSC] 水未开下配料；[QSC] 保鲜盒落地；[QSC] 饮料未使用规定器具称量'}]},

    {id: 'sd_dr_004', inspector: '钱磊', date: '2026-08-01', type: 'online', items: [{store: '平乐园店', score: 90, findings: '[QSC] 水未开下绿豆；[QSC] 未及时清洁；[QSC] 咸菜断档；[QSC] 焯水时间过长'}, {store: '宋家庄店', score: 91, findings: '[QSC] 水未开下小米；[QSC] 放油不标准；[QSC] 米饭未及时打散；[QSC] 汤汁过少；[QSC] 填补餐具未戴手套；[QSC] 一块面出七根半油条'}, {store: '和义南站店', score: 87, findings: '[QSC] 仪容仪表不合格；[QSC] 米饭未及时打散；[QSC] 未及时分装；[QSC] 垃圾溢出；[QSC] 佩戴首饰；[QSC] 交叉污染'}, {store: '通州耿庄店', score: 89, findings: '[QSC] 提前打烊；[QSC] 烧麦接触墙壁；[QSC] 米饭未及时打散；[QSC] 煎制时间不足；[QSC] 报损过多'}, {store: '驼房营店', score: 92, findings: '[QSC] 佩戴首饰；[QSC] 仪容仪表不合格；[QSC] 油条开叉；[QSC] 加料汁后未充分搅拌；[QSC] 加小葱未使用标准工器具'}]},

    {id: 'sd_dr_005', inspector: '钱磊', date: '2026-08-02', type: 'online', items: [{store: '晓月中路店', score: 90, findings: '[QSC] 蒸菜断档；[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理'}, {store: '德胜门店', score: 92, findings: '[QSC] 填补餐具未戴手套；[QSC] 超 30 分钟未处理；[QSC] 超 5 分钟未翻动；[QSC] 未溜边放'}, {store: '红庙店', score: 91, findings: '[QSC] 蒸菜断档；[QSC] 填补餐具未戴手套；[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理'}, {store: '内江路店', score: 88, findings: '[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理；[QSC] 炒菜断档；[QSC] 蒸菜断档；[QSC] 交叉污染'}, {store: '江苏路店', score: 92, findings: '[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理；[QSC] 夹子放入屉中；[QSC] 未用新碗'}, {store: '控江路店', score: 86, findings: '[QSC] 用手抓熟包子；[QSC] 报损过多；[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理；[QSC] 未溜边放；[QSC] 午餐蒸菜断档；[QSC] 晚餐蒸菜断档'}, {store: '小马厂店', score: 91, findings: '[QSC] 仪容仪表不合格；[QSC] 夹子接触桌面后继续使用；[QSC] 超 5 分钟未翻动；[QSC] 晚餐蒸菜断档'}, {store: '海淀黄庄店', score: 92, findings: '[QSC] 仪容仪表不合格；[QSC] 夹子接触桌面后继续使用；[QSC] 超 5 分钟未翻动；[QSC] 超 30 分钟未处理'}]},

    {id: 'sd_dr_006', inspector: '钱磊', date: '2026-08-04', type: 'online', items: [{store: '天通西苑店', score: 88, findings: '[QSC] 佩戴首饰；[QSC] 仪容仪表不合格；[QSC] 交叉污染；[QSC] 未及时分装；[QSC] 焯水时间过长；[QSC] 米饭未及时打散'}, {store: '小园地铁店', score: 90, findings: '[QSC] 包子掉落台面继续使用；[QSC] 米饭未加盖；[QSC] 提前打烊；[QSC] 仪容仪表不合格；[QSC] 米饭未及时打散'}, {store: '新天地店', score: 92, findings: '[QSC] 米饭未加盖；[QSC] 交叉污染；[QSC] 工牌无名字；[QSC] 米饭未及时打散'}, {store: '次渠店', score: 87, findings: '[QSC] 工牌无名字；[QSC] 仪容仪表不合格；[QSC] 水未开下配料；[QSC] 米饭未及时打散；[QSC] 报损过多；[QSC] 汤汁过少；[QSC] 浇油数量不标准；[QSC] 未及时清洁'}, {store: '莲怡园店', score: 86, findings: '[QSC] 未穿工服；[QSC] 米饭未加盖；[QSC] 浇油数量不标准；[QSC] 交叉污染；[QSC] 米饭未及时打散；[QSC] 咸菜断档；[QSC] 未及时清洁'}]},

    {id: 'sd_dr_007', inspector: '钱磊', date: '2026-08-05', type: 'online', items: [{store: '宛平城店', score: 95, findings: '[QSC] 未使用标准工器具；[QSC] 米饭未及时打散'}, {store: '草桥地铁店', score: 94, findings: '[QSC] 汤勺接触水龙头开关；[QSC] 提前打烊；[QSC] 报损过多；[QSC] 仪容仪表不合格'}, {store: '南站 2 店', score: 96, findings: '[QSC] 嘴里嚼东西；[QSC] 后厨摘帽子'}, {store: '角北店', score: 91, findings: '[QSC] 仪容仪表不合格；[QSC] 下馄饨未抖动；[QSC] 汤勺接触水龙头开关；[QSC] 未使用标准工器具称量'}, {store: '黄寺大街店', score: 89, findings: '[QSC] 汤勺接触桌面；[QSC] 仪容仪表不合格；[QSC] 三勺油两份肉；[QSC] 自助服务区未及时清洁；[QSC] 制作饮料未使用标准工器具'}]}

  ,{"id": "dr0100", "date": "2026-08-01", "inspector": "陶畅", "storeCount": 5, "issuesCount": 25, "type": "offline"},{"id": "dr0101", "date": "2026-08-01", "inspector": "马昕茹", "storeCount": 7, "issuesCount": 0, "type": "online"},{"id": "dr0103", "date": "2026-08-01", "inspector": "范晓明", "storeCount": 3, "issuesCount": 0, "type": "online"},{"id": "dr0104", "date": "2026-08-01", "inspector": "徐瑞雪", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0105", "date": "2026-08-01", "inspector": "乔雨地", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0106", "date": "2026-08-02", "inspector": "马昕茹", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0107", "date": "2026-08-02", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0109", "date": "2026-08-02", "inspector": "范晓明", "storeCount": 3, "issuesCount": 0, "type": "online"},{"id": "dr0110", "date": "2026-08-02", "inspector": "乔雨地", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0111", "date": "2026-08-02", "inspector": "王红丽", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0112", "date": "2026-08-03", "inspector": "范晓明", "storeCount": 3, "issuesCount": 0, "type": "online"},{"id": "dr0113", "date": "2026-08-03", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0114", "date": "2026-08-03", "inspector": "陶畅", "storeCount": 3, "issuesCount": 15, "type": "offline"},{"id": "dr0115", "date": "2026-08-03", "inspector": "王红丽", "storeCount": 3, "issuesCount": 3, "type": "offline"},{"id": "dr0116", "date": "2026-08-03", "inspector": "乔雨地", "storeCount": 6, "issuesCount": 14, "type": "offline"},{"id": "dr0117", "date": "2026-08-04", "inspector": "范晓明", "storeCount": 3, "issuesCount": 0, "type": "online"},{"id": "dr0118", "date": "2026-08-04", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0119", "date": "2026-08-04", "inspector": "陶畅", "storeCount": 3, "issuesCount": 15, "type": "offline"},{"id": "dr0120", "date": "2026-08-04", "inspector": "王红丽", "storeCount": 3, "issuesCount": 3, "type": "offline"},{"id": "dr0121", "date": "2026-08-04", "inspector": "乔雨地", "storeCount": 6, "issuesCount": 14, "type": "offline"},{"id": "dr0122", "date": "2026-08-05", "inspector": "马昕茹", "storeCount": 5, "issuesCount": 0, "type": "online"},{"id": "dr0123", "date": "2026-08-05", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0124", "date": "2026-08-05", "inspector": "陶畅", "storeCount": 5, "issuesCount": 25, "type": "offline"},{"id": "dr0126", "date": "2026-08-05", "inspector": "王红丽", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0127", "date": "2026-08-06", "inspector": "马昕茹", "storeCount": 2, "issuesCount": 0, "type": "online"},{"id": "dr0128", "date": "2026-08-06", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0129", "date": "2026-08-06", "inspector": "陶畅", "storeCount": 4, "issuesCount": 20, "type": "offline"},{"id": "dr0130", "date": "2026-08-06", "inspector": "徐瑞雪", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0131", "date": "2026-08-06", "inspector": "乔雨地", "storeCount": 5, "issuesCount": 5, "type": "offline"},{"id": "dr0132", "date": "2026-08-07", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0133", "date": "2026-08-07", "inspector": "钱磊", "storeCount": 5, "issuesCount": 0, "type": "online"},{"id": "dr0134", "date": "2026-08-07", "inspector": "陶畅", "storeCount": 5, "issuesCount": 25, "type": "offline"},{"id": "dr0135", "date": "2026-08-07", "inspector": "范晓明", "storeCount": 6, "issuesCount": 0, "type": "online"},{"id": "dr0136", "date": "2026-08-07", "inspector": "乔雨地", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0137", "date": "2026-08-07", "inspector": "王红丽", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0138", "date": "2026-08-07", "inspector": "徐瑞雪", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0139", "date": "2026-08-08", "inspector": "马昕茹", "storeCount": 4, "issuesCount": 0, "type": "online"},{"id": "dr0140", "date": "2026-08-08", "inspector": "张炜玉", "storeCount": 8, "issuesCount": 0, "type": "online"},{"id": "dr0141", "date": "2026-08-08", "inspector": "钱磊", "storeCount": 1, "issuesCount": 0, "type": "online"},{"id": "dr0142", "date": "2026-08-08", "inspector": "陶畅", "storeCount": 2, "issuesCount": 10, "type": "offline"},{"id": "dr0143", "date": "2026-08-08", "inspector": "王红丽", "storeCount": 5, "issuesCount": 5, "type": "offline"},{"id": "dr0144", "date": "2026-08-08", "inspector": "乔雨地", "storeCount": 2, "issuesCount": 2, "type": "offline"},{"id": "dr0145", "date": "2026-08-08", "inspector": "徐瑞雪", "storeCount": 3, "issuesCount": 3, "type": "offline"},{"id": "dr0146", "date": "2026-08-09", "inspector": "马昕茹", "storeCount": 4, "issuesCount": 0, "type": "online"},{"id": "dr0147", "date": "2026-08-09", "inspector": "钱磊", "storeCount": 4, "issuesCount": 0, "type": "online"},{"id": "dr0148", "date": "2026-08-09", "inspector": "范晓明", "storeCount": 5, "issuesCount": 0, "type": "online"},{"id": "dr0149", "date": "2026-08-09", "inspector": "陶畅", "storeCount": 4, "issuesCount": 20, "type": "offline"},{"id": "dr0150", "date": "2026-08-09", "inspector": "乔雨地", "storeCount": 4, "issuesCount": 4, "type": "offline"},{"id": "dr0151", "date": "2026-08-09", "inspector": "王红丽", "storeCount": 4, "issuesCount": 4, "type": "offline"}],
    ...
    {id: 'dr0102', date: '2026-08-01', inspector: '钱磊', storeCount: 5, issuesCount: 0, type: 'online'},

    {id: 'dr0103', date: '2026-08-01', inspector: '范晓明', storeCount: 3, issuesCount: 0, type: 'online'},

    {id: 'dr0104', date: '2026-08-01', inspector: '徐瑞雪', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0105', date: '2026-08-01', inspector: '乔雨地', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0106', date: '2026-08-02', inspector: '马昕茹', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0107', date: '2026-08-02', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0108', date: '2026-08-02', inspector: '钱磊', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0109', date: '2026-08-02', inspector: '范晓明', storeCount: 3, issuesCount: 0, type: 'online'},

    {id: 'dr0110', date: '2026-08-02', inspector: '乔雨地', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0111', date: '2026-08-02', inspector: '王红丽', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0112', date: '2026-08-03', inspector: '范晓明', storeCount: 3, issuesCount: 0, type: 'online'},

    {id: 'dr0113', date: '2026-08-03', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0114', date: '2026-08-03', inspector: '陶畅', storeCount: 3, issuesCount: 15, type: 'offline'},

    {id: 'dr0115', date: '2026-08-03', inspector: '王红丽', storeCount: 3, issuesCount: 3, type: 'offline'},

    {id: 'dr0116', date: '2026-08-03', inspector: '乔雨地', storeCount: 6, issuesCount: 14, type: 'offline'},

    {id: 'dr0117', date: '2026-08-04', inspector: '范晓明', storeCount: 3, issuesCount: 0, type: 'online'},

    {id: 'dr0118', date: '2026-08-04', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0119', date: '2026-08-04', inspector: '陶畅', storeCount: 3, issuesCount: 15, type: 'offline'},

    {id: 'dr0120', date: '2026-08-04', inspector: '王红丽', storeCount: 3, issuesCount: 3, type: 'offline'},

    {id: 'dr0121', date: '2026-08-04', inspector: '乔雨地', storeCount: 6, issuesCount: 14, type: 'offline'},

    {id: 'dr0122', date: '2026-08-05', inspector: '马昕茹', storeCount: 5, issuesCount: 0, type: 'online'},

    {id: 'dr0123', date: '2026-08-05', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0124', date: '2026-08-05', inspector: '陶畅', storeCount: 5, issuesCount: 25, type: 'offline'},

    {id: 'dr0125', date: '2026-08-05', inspector: '钱磊', storeCount: 5, issuesCount: 0, type: 'online'},

    {id: 'dr0126', date: '2026-08-05', inspector: '王红丽', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0127', date: '2026-08-06', inspector: '马昕茹', storeCount: 2, issuesCount: 0, type: 'online'},

    {id: 'dr0128', date: '2026-08-06', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0129', date: '2026-08-06', inspector: '陶畅', storeCount: 4, issuesCount: 20, type: 'offline'},

    {id: 'dr0130', date: '2026-08-06', inspector: '徐瑞雪', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0131', date: '2026-08-06', inspector: '乔雨地', storeCount: 5, issuesCount: 5, type: 'offline'},

    {id: 'dr0132', date: '2026-08-07', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0133', date: '2026-08-07', inspector: '钱磊', storeCount: 5, issuesCount: 0, type: 'online'},

    {id: 'dr0134', date: '2026-08-07', inspector: '陶畅', storeCount: 5, issuesCount: 25, type: 'offline'},

    {id: 'dr0135', date: '2026-08-07', inspector: '范晓明', storeCount: 6, issuesCount: 0, type: 'online'},

    {id: 'dr0136', date: '2026-08-07', inspector: '乔雨地', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0137', date: '2026-08-07', inspector: '王红丽', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0138', date: '2026-08-07', inspector: '徐瑞雪', storeCount: 4, issuesCount: 4, type: 'offline'},

    {id: 'dr0139', date: '2026-08-08', inspector: '马昕茹', storeCount: 4, issuesCount: 0, type: 'online'},

    {id: 'dr0140', date: '2026-08-08', inspector: '张炜玉', storeCount: 8, issuesCount: 0, type: 'online'},

    {id: 'dr0141', date: '2026-08-08', inspector: '钱磊', storeCount: 1, issuesCount: 0, type: 'online'},

    {id: 'dr0142', date: '2026-08-08', inspector: '陶畅', storeCount: 2, issuesCount: 10, type: 'offline'},

    {id: 'dr0143', date: '2026-08-08', inspector: '王红丽', storeCount: 5, issuesCount: 5, type: 'offline'},

    {id: 'dr0144', date: '2026-08-08', inspector: '乔雨地', storeCount: 2, issuesCount: 2, type: 'offline'},

    {id: 'dr0145', date: '2026-08-08', inspector: '徐瑞雪', storeCount: 3, issuesCount: 3, type: 'offline'},

    {id: 'dr0146', date: '2026-08-09', inspector: '马昕茹', storeCount: 4, issuesCount: 0, type: 'online'},

    {id: 'dr0147', date: '2026-08-09', inspector: '钱磊', storeCount: 4, issuesCount: 0, type: 'online'},

    {id: 'dr0148', date: '2026-08-09', inspector: '范晓明', storeCount: 5, issuesCount: 0, type: 'online'},

    {id: 'dr0149', date: '2026-08-09', inspector: '陶畅', storeCount: 4, issuesCount: 20, type: 'offline'},

    {id: 'dr0150', date: '2026-08-09', inspector: '乔雨地', storeCount: 4, issuesCount: 4, type: 'offline'},
